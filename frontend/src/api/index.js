...
export const whatsappAPI = {
  ...
  // body may carry { phone } for invoices raised without a customer number
  sendInvoice: (saleId, body) => api.post(`/whatsapp/send-invoice/${saleId}`, body || {}),
...
export const dayBookAPI = {
  ...
  saveSnapshot: (date) => api.post('/daybook/snapshot', { date }),
  getSnapshot: (date) => api.get('/daybook/snapshot', { params: { date } }),
  listSnapshots: () => api.get('/daybook/snapshots'),
  ...
  checkBridalAvailability: (set_code, function_date) => api.get('/daybook/bridal-bookings/availability', { params: { set_code, function_date } }),
...
export const bridalAPI = {
  ...
  bulkUpdateInventory: (ids, updates) => api.put('/bridal/inventory/bulk-update', { ids, updates }),
  // Bookings
