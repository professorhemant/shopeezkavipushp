...
// Presentational view of a Day Book summary (the payload returned by
// dayBookAPI.getSummary). Shared by Total Received (today) and Saved Day Book
// (previous days).
export default function DayBookSummaryView({ data }) {
  if (!data) return null
  return (
    <>
      {/* Summary Cards */}
