...
import {
  ...
  PieChart, Wallet, Shield, Send, QrCode,
...
const MENU = [
  ...
  { id: 'customers', label: 'Customers',          icon: Users,           path: '/customers' },
  {
    ...
    children: [
      { label: 'Create Invoice',        path: '/billing/invoices/create',        icon: Plus },
      { label: 'Create Manual Invoice', path: '/billing/invoices/create-manual', icon: PenLine },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Image Upload',        path: '/inventory/image-editor',     icon: Upload },
